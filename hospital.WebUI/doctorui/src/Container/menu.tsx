            ...
            <div className="nk-sidebar-inner" data-simplebar>
              ...
              <div className="nk-menu-content" data-content="navHospital">
                ...
                <ul className="nk-menu">
                  ...
                  <li className="nk-menu-item has-sub"><a href="#" className="nk-menu-link nk-menu-toggle"><span
                    className="nk-menu-icon"><em className="icon ni ni-plus-medi-fill"></em></span><span
                      className="nk-menu-text">Doctors / Nurses</span></a>
                    <ul className="nk-menu-sub">
                      <li className="nk-menu-item"><a href="hospital/doctor-nurse-add.html"
                        className="nk-menu-link"><span className="nk-menu-text">Add Doctor /
                          Nurses</span></a></li>
                      <li className="nk-menu-item"><a href="hospital/doctor-nurse-list.html"
                        className="nk-menu-link"><span className="nk-menu-text">Doctors / Nurses</span></a>
                      </li>
                    </ul>
                  </li>
                  <li className="nk-menu-item has-sub"><a href="#" className="nk-menu-link nk-menu-toggle"><span
